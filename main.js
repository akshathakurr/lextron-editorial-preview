...
function initBlog() {
  ...
  grid.innerHTML = articles.map((post) => `
    <a class="article-card" href="/lextron-editorial-preview/blog/${post.slug}/">
  ...
  root.innerHTML = `
    ...
    <header class="site-header">
      <div class="shell header-inner">
        <a class="wordmark" href="/lextron-editorial-preview/blog/" aria-label="Lextron home">Lextron</a>
        <nav class="primary-nav" aria-label="Primary"><a href="/lextron-editorial-preview/blog/" aria-current="page">Journal</a><a href="/lextron-editorial-preview/ai-glossary/">Glossary</a></nav>
        <a class="header-cta" href="https://app.lextronai.com/start">Start a document <span aria-hidden="true">↗</span></a>
      </div>
    </header>
    <main id="main" class="article-page">
      <div class="shell">
        <a class="article-back" href="/lextron-editorial-preview/blog/"><span aria-hidden="true">←</span> Journal</a>
        <article>
        ...
        <aside class="related-posts" aria-labelledby="related-heading">
          ...
          <div>${related.map((entry) => `<a href="/lextron-editorial-preview/blog/${entry.slug}/"><span>${escapeHTML(entry.category)}</span><strong>${escapeHTML(entry.title)}</strong></a>`).join('')}</div>
        </aside>
      </div>
    </main>
    <footer class="site-footer"><div class="shell footer-inner"><a class="wordmark" href="/lextron-editorial-preview/blog/">Lextron</a><nav aria-label="Footer"><a href="/lextron-editorial-preview/blog/">Journal</a><a href="/lextron-editorial-preview/ai-glossary/">Glossary</a><a href="https://lextronai.com/">Main site ↗</a></nav><span>© 2026 Lextron</span></div></footer>`
}
